(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Route = /** @class */ (function () {
        ...
        Route.prototype.shift = function () {
        ...
        Route.prototype.show = function (path, view, kids) {
            ...
            return new Promise(function (res, rej) {
                ...
                obj.confirm.catch(function () { return obj.redirect = null; }).then(function () {
    ...
    var JetAppBase = /** @class */ (function (_super) {
        ...
        function JetAppBase(config) {
            ...
            _this = _super.call(this, webix) || this;
            // init config
        ...
        JetAppBase.prototype.clickHandler = function (e) {
            if (e) {
        ...
        JetAppBase.prototype.createFromURL = function (chunk, now) {
            var _this = this;
            var view;
        ...
        JetAppBase.prototype.createView = function (ui, name) {
            var obj;
        ...
        // show view path
        JetAppBase.prototype.show = function (url) {
        ...
        // renders top view
        JetAppBase.prototype.render = function (root, url, parent) {
            var _this = this;
            ...
            if (firstInit) {
                if (_once) {
                    this.webix.attachEvent("onClick", function (e) { return _this.clickHandler(e); });
                    _once = false;
                }
                if (typeof url === "string") {
                    url = new Route(url, 0);
            ...
            var ready = segment.show(path, top)
                .then(function () { return _this.createFromURL(segment.current(), top); })
    ...
    var JetApp = /** @class */ (function (_super) {
        ...
        JetApp.prototype._loadViewDynamic = function (url) {
            url = url.replace(/\./g, "/");
