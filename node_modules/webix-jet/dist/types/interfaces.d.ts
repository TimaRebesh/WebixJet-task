...
export interface IWebixFacade {
    ...
    uid(): number;
    ui(config: any, cont?: string | HTMLElement | IBaseView): IBaseView;
    bind(handler: any, master: any): any;
    message(text: any): any;
    dp(id: string): any;
...
export interface IJetView {
    ...
    refresh(): Promise<IBaseView>;
    render(area: ISubView | string | HTMLElement, url?: IRoute, parent?: IJetView): Promise<IBaseView>;
    destructor(): any;
...
export interface IJetRouterFactory {
    new (cb: IJetRouterCallback, config: any, app: IJetApp): any;
}
...
export interface IRoute {
    ...
    refresh(): void;
    size(n: number): any;
    update(name: string, value: string, index?: number): any;
    split(): IRoute;
