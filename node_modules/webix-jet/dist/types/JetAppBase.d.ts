...
import { IBaseView, IJetApp, IJetConfig, IJetRouter, IJetURL, IJetURLChunk, IJetView, IRoute, ISubView, IViewConfig } from "./interfaces";
export declare class JetAppBase extends JetBase implements IJetView {
    ...
    render(root?: string | HTMLElement | ISubView, url?: IRoute | string, parent?: IJetView): Promise<IBaseView>;
    getSubView(): IJetView;
