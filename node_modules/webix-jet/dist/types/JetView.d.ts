...
import { IBaseConfig, IBaseView, IJetApp, IJetURL, IJetView, IJetViewFactory, ISubView, IUIConfig, IRoute } from "./interfaces";
export declare class JetView extends JetBase {
    ...
    _show(segment: IRoute, path: string, view: IJetView): Promise<void>;
